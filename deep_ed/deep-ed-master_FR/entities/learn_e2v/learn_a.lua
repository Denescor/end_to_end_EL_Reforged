...
---------------- runtime options:
cmd:option('-type', 'float', 'Type: double | float | cuda | cudacudnn')
...
function train_ent_vecs()
  ...
  local save_every_num_epochs = 50
  
  -- epoch tracker
  epoch = 1
  max_epoch = 251 -- limit of learning
  ...
  -- do one epoch
  print('training during ' .. max_epoch .. ' epochs')
