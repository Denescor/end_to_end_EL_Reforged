...
def main():
    train_entities, train_mentions = process_file("TR_train.txt")
    dev_entities, dev_mentions = process_file("TR_dev.txt")
    test_entities, test_mentions = process_file("TR_test.txt")
