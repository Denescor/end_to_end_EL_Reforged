...
def load_ent_vecs(args):
    ent_vecs_name = args.entity_vecs_name
    entity_embeddings_nparray = np.load(config.base_folder + "data/entities/ent_vecs/" + ent_vecs_name) # Soit "ent_vecs.npy", "ent_vecs_reinforced.npy", "ent_vecs_glove.npy"
    entity_embeddings_nparray[0] = 0
    if hasattr(args, 'entity_extension') and args.entity_extension is not None:
        entity_extension = np.load(config.base_folder +"data/entities/"+args.entity_extension+"/ent_vecs/"+ent_vecs_name) # Soit "ent_vecs.npy", "ent_vecs_reinforced.npy", "ent_vecs_glove.npy"
