...
def train():
    ...
    elif not args.notfreeze:
        from model.model_with_freeze import Model #TODO remove and unify model and model_with_freeze
    else:
...
def _parse_args():
    ...
    parser.add_argument("--freeze_low_layers", dest="notfreeze", action="store_false") #Activate option to freeze char and contextual layers
    parser.set_defaults(notfreeze=True) #notfreeze = False ==> Do Not freeze chars layers and contextual layers
